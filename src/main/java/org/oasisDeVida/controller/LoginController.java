...
import org.oasisDeVida.model.service.IUsuarioRepository;
import org.oasisDeVida.model.service.LoginMgrImpl;
import org.oasisDeVida.model.service.UserDetailsMgrImpl;
import org.oasisDeVida.modelo.entity.Usuario;
import org.oasisDeVida.utils.connection.Constantes;
	...
	public String inicio(Model model, HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if(usuario != null && usuario.getClaveTemporal().equals("S")) {
			return changePassword();	
				...
				resp.sendRedirect("/oasisdevida/principal");
